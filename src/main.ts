...
import { BT1_Minus1_Y_nSS, BT2_Minus1_Y_nSS } from '@/notations/BM-like/BTstar_Minus1_Y_nSS.ts';
...
register_notation(BT2_Minus1_Y_nSS(1));
register_notation(BT2_Minus1_Y_nSS(2));
register_notation(BT2_Minus1_Y_nSS(3));
