...
import { TBM } from '@/notations/TBM';
import { Y_seq } from '@/notations/Y';
import { omega_Y_actual, omega_Y_medium, omega_Y_strong, omega_Y_weak } from '@/notations/Omega_Y.ts';
import { omega_MN } from '@/notations/Omega_MN.ts';
import { T_omega_MN } from '@/notations/T_omega_MN.ts';
import { BHM } from '@/notations/BHM';
import { BSM } from '@/notations/BSM';
import { DEN } from '@/notations/DEN';
import { DEN2 } from '@/notations/DEN2';
import { DEN3 } from '@/notations/DEN3';
import { aSAN } from '@/notations/aSAN/aSAN.ts';
import { LMN } from '@/notations/LMN';
import { LON } from '@/notations/LON';
import { UPMS } from '@/notations/UPMS';
import { register_notation } from '@/core/registry';
import { DEFAULT_SETTINGS, Settings } from '@/core/settings';
import { SETTINGS_KEY } from '@/composables/use_settings.ts';
import { A_omega2_MN2, wA_omega2_MN2 } from '@/notations/Aw2MN2.ts';
